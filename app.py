...
with st.sidebar:
    ...
    st.markdown("**🩻 Radiology** (Current)")
    
    # Button to navigate to Cardiology
    if st.button("❤️ Go to Cardiology", use_container_width=True):
        st.switch_page("pages/cardiology.py")
